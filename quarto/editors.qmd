...
eds_gen <- ed_status$editor [which (ed_status$general)]
timeline <- timeline [timeline$name %in% eds_gen, ]
...
concurrent reviews in a one-month period. (Note that some editors handle both
general and statistical packages, and so appear in both plots.)
