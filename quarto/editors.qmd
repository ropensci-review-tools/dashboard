...
ongoing reviews, and numbers who are free to accept new submissions.

An editor is considered "Busy" in a given quarter if they have accepted a new
submission during that quarter, regardless of how many concurrent submissions
they may also be handling at that time.

```{r ed-availability-prepro, echo = FALSE}
# Use all editors, not just current ones
num_eds_busy <- ed_dat$timeline_new |>
