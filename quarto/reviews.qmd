...
Some cells in the following table are highlighted to visually indicate the
following degrees of urgency:
...
The levels of urgency used in this table are explained at the end.
