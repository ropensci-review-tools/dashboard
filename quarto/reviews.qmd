...
dat_holding <- rev_dat [grep ("holding", rev_dat$labels), ] # TODO: Include these
...
Stage" listed in the check-boxes. Some rows in the table are highlighted to
visually indicate the following degrees of urgency according to the scheme
defined below.
...
The levels of urgency used in this table are explained at the end. Rows with no
...
urgency of `floor(12 * 7 / 21) = 4`. These urgency levels define the colour
codes shown at the top of this page.
