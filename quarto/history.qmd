...
Plot.plot({
    ...
    marks: [
        ...
        Plot.barY(revHistFiltered, Plot.binX({y: "count"}, {x: "days", stroke: "#4e79a7", strokeWidth: 2})),
...
Plot.plot({
    ...
    y: {grid: true},
    marks: [
        Plot.barY(revHistFiltered, Plot.binX({y: "count"}, {x: "hours", stroke: "#4e79a7", strokeWidth: 2})),
